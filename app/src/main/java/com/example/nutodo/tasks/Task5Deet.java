...
public class Task5Deet extends Fragment {

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
                             @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_task5_deet, container, false);

        // Back button click listener
        view.findViewById(R.id.backButton).setOnClickListener(v ->
                Navigation.findNavController(view).navigate(R.id.action_task5Deet_to_tasksFragment));
        ...
        view.findViewById(R.id.work1_card).setOnClickListener(v ->
                Toast.makeText(getContext(), "User Activity", Toast.LENGTH_SHORT).show());
